...
int main(int argc, char** argv)
{
    ...
    if (argc > 3) {
        ...
        std::string groundtruthPath = argv[4];
    ...
    VideoWriter video_out(ouput_path, CV_FOURCC('M','J','P','G') , 30, Size(frame_width, frame_height), true);
